...
2. Em "propose_action", preencha platformCampaignId, platformAdId E platformAdSetId com os 3 ids reais do passo 1 (mesmo quando a proposta so precisaria de um deles pra sair de "precisa de mais dados") - a execucao real mais tarde pode exigir o adSetId tambem dependendo do tipo/plataforma, e so descobrir isso na hora de executar vira "falha tecnica" evitavel. Inclua tambem em metricsJson pelo menos um campo real de spend/ctr/cpc/cpl/cpa/conversions do passo 1.
